...
namespace Poker
{
    class DealCards : DeckOfCards
    {
        ...
        public void Deal()
        {
            ...
            DisplayCards(); //Deixnei tis kartes
        ...
        public void DisplayCards()
        {
            ...
            Console.WriteLine("Xeri tou paikth");
            for (int i = 0; i < 2; i++) 
            {
            ...
            Console.WriteLine("Xeri toy ypologisth");            
            for (int i = 0; i < 2; i++)
            {                
                DrawCards.DrawCardOutline(x, y);
        ...
        public void EvaluateHands()
        {
            ...
            //emfanisi xeriou
            Console.WriteLine("\n\n\n\n\n\n\n\nXeri tou paikth: " + playerHand);
            Console.WriteLine("\nXeri toy ypologisth: " + computerHand);

            //evaluate hands
            if (playerHand > computerHand)
            {
                Console.WriteLine("O paiktis kerdise!");
            }
            else if (playerHand < computerHand)
            {
                Console.WriteLine("O ypologisths kerdise!");
            }
            else 
            ...
            {
                //prota koitame poios exei megalyterh axia sto hand
